...
<body>
    ...
    <div class="navbar"> 
      ...
      <?php require_once(ROOT_PATH . '/public_functions.php');
        $noticias = getPublishedPostsCategoria4(); 
      ?> 
...
<div class="filtros-entrevista2">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
          ...
          <li><a class="dropdown-item active" href="copa.php">Copa</a></li>
...
<div class="container-noticia-2">    
    <div class="sub-container-n2">
      <?php 
        ...
        $sql = "SELECT * FROM noticia WHERE categoria_noticia=4 order by created_at desc;";
