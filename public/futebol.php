...
<body>
    ...
    <div class="navbar"> 
      ...
      <?php require_once(ROOT_PATH . '/public_functions.php');
        $noticias = getPublishedPostsCategoria2(); 
      ?> 
...
<div class="filtros-entrevista2">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
          ...
          <li><a class="dropdown-item active" href="futebol.php">Futebol</a></li>
...
<div class="container-noticia-2">    
    <div class="sub-container-n2">
      <?php 
        ...
        $sql = "SELECT * FROM noticia WHERE categoria_noticia=2 order by created_at desc;";
